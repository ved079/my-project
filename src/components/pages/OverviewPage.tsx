...
export function OverviewPage() {
  ...
  return (
    <div>
      <h1 style={{ position: 'absolute', width: 1, height: 1, padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', borderWidth: 0 }}>Newmi Care — Marketing Operations Dashboard</h1>
